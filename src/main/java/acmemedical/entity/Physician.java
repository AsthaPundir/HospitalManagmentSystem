...
@NamedQuery(name = Physician.QUERY_PHYSICIAN_BY_ID, query = "SELECT p FROM Physician p where p.id = :param1")
public class Physician extends PojoBase implements Serializable {
	...
	/// Simplify JSON body, skip MedicalCertificate
	  @JsonIgnore
    ...
    // Simplify JSON body, skip Prescription
    @JsonIgnore
