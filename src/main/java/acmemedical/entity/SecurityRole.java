...
//@NamedQuery(name = SecurityRole.FIND_PHYSICIN_WITH_ROLE, query ="SELECT sr FROM SecurityRole sr LEFT JOIN FETCH sr.users where sr.physician = :param1 ")
@NamedQuery(name = SecurityRole.FIND_PHYSICIAN_WITH_ROLE, query = "SELECT u FROM SecurityUser u left JOIN FETCH u.physician left JOIN FETCH u.roles WHERE u.physician.id = :param1")
public class SecurityRole implements Serializable {
    /** Explicit set serialVersionUID */
    private static final long serialVersionUID = 1L;
    public static final String FIND_USER_ROLE = "SecurityRole.findAll";
    public static final String FIND_PHYSICIAN_WITH_ROLE = "SecurityUser.find";
