...
import static acmemedical.entity.SecurityUser.*;
...
@NamedQueries(value = {@NamedQuery(name = USER_FOR_OWNING_PHYSICIAN_QUERY, query = "SELECT u FROM SecurityUser u left JOIN FETCH u.physician left JOIN FETCH u.roles WHERE u.physician.id = :param1"),
@NamedQuery(name = SECURITY_USER_BY_NAME_QUERY, query = "SELECT u FROM SecurityUser u left JOIN FETCH u.physician left JOIN FETCH u.roles WHERE u.username = :param1")})
...
public class SecurityUser implements Serializable, Principal {
    ...
    public static final String USER_FOR_OWNING_PHYSICIAN_QUERY = "SecurityUser.userForOwningPhysician";
