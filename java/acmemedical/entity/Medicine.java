...
//@NamedQuery(name = Medicine.IS_DUPLICATE_QUERY_NAME, query = "SELECT count(m) FROM Medicine m where m.drug_name = :param1 and m.manufacturer_name = :param2 and m.dosage_information = :param3")
//@NamedQuery(name = Medicine.QUERY_MEDICINE_BY_NAME_DRUG, query = "SELECT m FROM Medicine m where m.drug_name = :param1 and m.manufacturer_name = :param2 and m.dosage_information = :param3)
...
@NamedQueries({
	@NamedQuery(name = Medicine.ALL_MEDICINES_QUERY, query = "SELECT m FROM Medicine m"),
	@NamedQuery(name = Medicine.MEDICINE_BY_ID, query = "SELECT m FROM Medicine m WHERE m.id = :param1")
})
...
public class Medicine extends PojoBase implements Serializable {
	...
	public static final String ALL_MEDICINES_QUERY = "Medicine.getAll Medicines";
	public static final String MEDICINE_BY_ID = "Medicine.getMedicineById";
//  public static final String IS_DUPLICATE_QUERY_NAME = "Medicine.isDuplicate";
//  public static final String QUERY_MEDICINE_BY_NAME_DRUG = "Medicine.findByNameDrug";
