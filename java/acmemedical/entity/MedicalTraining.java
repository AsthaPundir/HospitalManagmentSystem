...
@NamedQuery(name = MedicalTraining.FIND_ALL, query = "SELECT mt FROM MedicalTraining mt LEFT JOIN FETCH mt.certificate LEFT JOIN FETCH mt.certificate")
...
public class MedicalTraining extends PojoBase implements Serializable {
    ...
    public static final String FIND_BY_ID = "MedicalTraining.findById";  // Fixed naming to be consistent
	...
	//Changes to this class should not cascade to MedicalCertificate
